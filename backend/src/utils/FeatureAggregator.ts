...
export const FEATURE_LABELS: Record<(typeof FEATURE_COLUMNS)[number], string> = {
  ...
  irritabilityLevel: 'Irritability Level',
  lonelinessLevel: 'Loneliness Level',
  selfEfficacy: 'Self Efficacy',
  copingAbility: 'Coping Ability',
  powerInternetDisruption: 'Power/Internet Disruption',
  wfhEnvironmentQuality: 'WFH Environment Quality',
  familyResponsibilityLoad: 'Family Responsibility Load',
  salaryWorkloadSatisfaction: 'Salary/Workload Satisfaction',
  afterHoursMessaging: 'After Hours Messaging',
  meetingsCount: 'Meetings Count',
  urgentTasksCount: 'Urgent Tasks Count',
  sprintPressureRating: 'Sprint Pressure Rating',
  deadlineFrequency: 'Deadline Frequency',
  isWeekendWork: 'Weekend Work',
  bugFixingLoad: 'Bug Fixing Load',
  contextSwitchingFrequency: 'Context Switching Frequency',
  isOnCallToday: 'On Call Today',
  workModeEncoded: 'Work Model',
  managerSupportLevel: 'Manager Support Level',
  peerSupportLevel: 'Peer Support Level',
